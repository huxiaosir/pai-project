...
import org.joisen.paicoding.forum.api.model.exception.ExceptionUtil;
import org.joisen.paicoding.forum.api.model.exception.ForumException;
import org.joisen.paicoding.forum.api.model.vo.ResVo;
...
import org.joisen.paicoding.forum.core.util.JsonUtil;
...
/**
 * 全局异常处理
 * （除了这种方式，可以使用ControllerAdvice注解的方式）
 * @author Joisen
 * @version 1.0
 * @date 2025/2/21 021 16:54
 */
@Slf4j
@Order(-100)
